"""
tests/test_release_manager.py – Testet echtes Release-Management (core/release_manager.py)
...
Zeichenkette. release_manager.py leitet SemVer-Bumps aus der bereits etablierten
...
class TestGitIntegration(unittest.TestCase):
    ...
    def test_no_tag_yet_returns_none(self):
        with patch("core.release_manager.BASE_DIR", self.work_dir):
...
class TestCreateRelease(unittest.TestCase):
    ...
    def test_creates_real_tag_pushes_it_and_calls_gh_release_create(self):
        ...
        with patch("core.release_manager.BASE_DIR", self.work_dir), \
             patch("core.release_manager.subprocess.run", side_effect=fake_run):
